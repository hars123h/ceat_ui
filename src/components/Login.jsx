    ...
    return (
        <div className='relative bg-white'>
            ...
            <div className='text-center'>
                <img src={jlogo} alt="hp_logo" className='m-auto md:w-2/6 sm:w-1/6 mt-10 mb-14' width={270} />
            </div>
            <div className='flex flex-col m-auto w-[79%]'>
                ...
                <div className='mt-12 flex flex-col gap-6'>
                    <button onClick={handleSignIn} className='bg-red-800 w-full py-[10px] text-[20px] text-white rounded-full shadow-ceatShadow shadow-red-800
                    '>Login</button>
